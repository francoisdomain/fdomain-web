...
export const blogArticles: Record<string, BlogArticle> = {
  "everyone-is-a-leader": {
    ...
    body: `
How many times have you heard (or told yourself), <em>“I’m not a leader”</em>?
...
Leadership isn’t about the <em>how</em>—it’s about the <em>why</em>.
...
💡 <strong>Leadership isn’t something you learn—it’s something you stumble upon.</strong>

The moment you find something you believe in so deeply that you <strong>can’t <em>not</em> act</strong>—that’s leadership. 
...
🔥 <strong>Don’t chase leadership. Find your reason, and leadership will follow.</strong>    `,
